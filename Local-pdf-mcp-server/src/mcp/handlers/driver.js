import { DEFAULT_DRIVER_PACK_MODE, DRIVER_ARTIFACT_SCHEMA_VERSION, SERVER_VERSION } from "../../core/runtime-constants.js";
import { sourceFingerprint } from "../../artifacts/manifest.js";
import { atomicWriteFile, atomicWriteJson, clampTopK, getPdfSourceInfo, safeArtifactManifestPath, safeDriverPackJsonPath, safeDriverPackMarkdownPath, safeDriverPackPath, safeDriverTaskPlanJsonPath, safeDriverTaskPlanMarkdownPath, safeDriverTaskPlanPath, textResult } from "../../core/runtime-helpers.js";
import { createRuntimePort } from "../../core/runtime-ports.js";
import { nowIso, writeArtifactManifest } from "../../services/jobs.js";
import { buildDriverEvidencePack, buildDriverEvidencePackContract, buildDriverTaskPlan, buildDriverTaskPlanEvidenceContract, formatDriverEvidencePack, formatDriverTaskPlan, formatVerifyRegisterUsage, normalizeStringArray, verifyRegisterUsage } from "../../workflows/driver-pack.js";
...
async function handle_prepare_driver_task(args = {}, meta = {}) {
  const name = meta.name || "prepare_driver_task";
    ...
    await atomicWriteJson(taskPlanJsonPath, {
      ...
      sourceFingerprint: plan.sourceFingerprint || sourceFingerprint(await getPdfSourceInfo(filename, { includeHash: true })),
      plan,
      evidenceContract,
...
async function handle_build_driver_evidence_pack(args = {}, meta = {}) {
  const name = meta.name || "build_driver_evidence_pack";
    ...
    await atomicWriteJson(driverPackJsonPath, {
      ...
      sourceFingerprint: pack.sourceFingerprint || sourceFingerprint(await getPdfSourceInfo(filename, { includeHash: true })),
      pack,
      evidenceContract,
