  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        step40_action: {
          type: "string",
          enum: ["health", "ping", "compat_report", "index_status_lite", "ocr_health", "rebuild_artifact", "job_status", "list_jobs", "cancel_job", "cleanup_jobs", "figure_cache_status", "cleanup_figure_cache"],
        ...
        filename: { type: "string", description: "PDF filename for step40_action=index_status_lite, rebuild_artifact, figure_cache_status, or cleanup_figure_cache." },
        ...
        older_than_hours: { type: "number", description: "Age filter for step40_action=cleanup_jobs or cleanup_figure_cache." },
        max_bytes: { type: "number", description: "Cache size target for step40_action=cleanup_figure_cache; oldest matching files are selected until total cache bytes are under this value." },
        confirm: { type: "boolean", description: "Required true for step40_action=cleanup_figure_cache to delete files. Without confirm, cleanup runs as dry-run." },
