...
const FIGURE_AGENT_INSTRUCTION = [
  ...
  "For RICA/Continue-style clients, call get_figure_image with transport=\"image_url\". The client must bridge structuredContent.image_transport.imageUrls into MessagePart imageUrl inputs. image_path is only a locator.",
  "If MCP image content is returned by the client, inspect pixels; otherwise open/attach the canonical local image or bridge image_url data URIs before making claims about figure/table/bit-layout/timing/data-format semantics.",
...
const VISUAL_CONTRACT = Object.freeze({
  ...
  preferred_rica_transport: "image_url",
