...
export function formatRenderResult(result) {
  ...
  if (result.renderer === "text_svg") {
    ...
    lines.push("Debug/compatibility output only. For normal figure/table analysis, prefer search_figures -> get_figure_context_pack -> get_figure_image and open/attach the canonical PNG as actual model vision input.");
  }
  lines.push("");
